package com.gsha.annuairegsh.ViewCaller;
...
public class NewTicketNotification {
    ...
    public static void notify(final Context context,
        ...
        final Bitmap picture = BitmapFactory.decodeResource(res, R.drawable.ic_close_black_24dp);


        String titreTicket ="TITRE";
        String descriptionTicket ="infoTicket.getString";
        String dateTicket = "infoTicket";
        String textShare = "Ticket ouvert le "+dateTicket+".\n\nTitre : "+titreTicket+"\n\nDescription : \n"+descriptionTicket+"\n\nID : "+number+".";

        final String ticker = titreTicket ;
        final String title = "YO TEXT";
